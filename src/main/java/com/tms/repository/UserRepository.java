...
public class UserRepository {
    ...
    public User saveUser(User userInput) {
        GeneratedKeyHolder keyHolder = new GeneratedKeyHolder(); // Для того чтобы сохранить и после получить id
    ...
    public List<User> findAll() {
        return jdbcTemplate.query(SqlQueries.SQL_SELECT_ALL_USERS,
